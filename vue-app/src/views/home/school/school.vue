  ...
  <el-table
    ...
    <el-table-column label="操作">
      <template slot-scope="scope">
        <el-button
          size="mini"
          @click="editSchool(scope.row)">编辑</el-button>
        <el-button
          size="mini"
          type="danger"
  ...
  export default {
    ...
    methods: {
     /* //查询所有学院
      getAllSchools(){
        var _this=this;
        axios.get("http://localhost:8080/Campus_Help/admin/getAllSchool").then((resp)=>{
          _this.tableData=resp.data.extend.schoolList;
        })
      },*/
      ...
      showCurrentPage() {
        ...
        this.$http.get("admin/getAllSchool/"+_this.page.currentPage+"/"+_this.page.pageSize).then(resp=>{
          console.log(resp.data);
          _this.tableData = resp.data.extend.schoolList.list;
          _this.page.currentPage = resp.data.extend.schoolList.pageNum;
          _this.page.pageSize = resp.data.extend.schoolList.pageSize;
          _this.page.total = resp.data.extend.schoolList.total;
          _this.page.pages = resp.data.extend.schoolList.pages;
          _this.page.size = resp.data.extend.schoolList.size;
        })
      },
